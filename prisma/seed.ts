...
async function main() {
  ...
  for (const [i, slide] of [
    {
      ...
      ru: { subtitle: 'Ваш путь к справедливости начинается здесь', title: 'Добро пожаловать в LSA Law Firm', description: 'Предоставляем исключительные юридические услуги с приверженностью профессионализму и совершенству.', buttonText: 'Позвонить' },
      en: { subtitle: 'Your Journey to Justice Starts Here', title: 'Welcome to LSA Law Firm', description: 'Providing exceptional legal services with a commitment to professionalism and excellence.', buttonText: 'Call Now' },
    },
    {
  ...
  const teamData = [
    {
      ...
      ru: { name: 'Татевик Малхасян', position: 'Директор компании, Адвокат', bio: JSON.stringify(['Татевик Малхасян является адвокатом в юридической фирме «LSA». Она специализируется как в уголовном, так и в корпоративном праве, в частности, оказывает юридическую поддержку при регистрации коммерческих компаний, фондов и некоммерческих организаций.', 'Её профессиональный опыт в юридической фирме «LSA» начался в 2015 году. Ранее она имела опыт работы в частных и государственных учреждениях.', 'В 2009 году она с отличием окончила юридический факультет Ереванского государственного университета. Впоследствии получила степень магистра права.', 'Владеет армянским, русским и английским языками.']) },
      en: { name: 'Tatevik Malkhasyan', position: 'Company Director, Lawyer', bio: JSON.stringify(['Tatevik Malkhasyan is a lawyer at LSA Law Firm. She specializes in both criminal and corporate law.', 'She graduated from the Yerevan State University Faculty of Law in 2009 with honors.', 'She speaks Armenian, Russian, and English.']) },
    },
    {
      slug: 'andranik-mnatsakanyan', imageUrl: '/images/team/team2.jpg', licenseNumber: '№ 2345', order: 1,
      ru: { name: 'Андраник Мнацаканян', position: 'Партнер, Адвокат', bio: JSON.stringify(['Андраник Мнацаканян является партнером и адвокатом в юридической фирме «LSA». Он специализируется в области гражданского и коммерческого права.', 'Его профессиональный опыт включает работу над сложными коммерческими спорами, сделками с недвижимостью и корпоративными реструктуризациями.', 'Владеет армянским, русским и английским языками.']) },
      en: { name: 'Andranik Mnatsakanyan', position: 'Partner, Lawyer', bio: JSON.stringify(['Andranik Mnatsakanyan is a partner and lawyer at LSA Law Firm. He specializes in civil and commercial law.', 'He speaks Armenian, Russian, and English.']) },
    },
    {
      slug: 'gurgen-nersisyan', imageUrl: '/images/team/team3.jpg', licenseNumber: '№ 3456', order: 2,
      ru: { name: 'Гурген Нерсисян', position: 'Партнер, Адвокат', bio: JSON.stringify(['Гурген Нерсисян является партнером и адвокатом в юридической фирме «LSA». Он специализируется в области уголовного права и защиты прав человека.', 'Владеет армянским, русским, английским и французским языками.']) },
      en: { name: 'Gurgen Nersisyan', position: 'Partner, Lawyer', bio: JSON.stringify(['Gurgen Nersisyan is a partner and lawyer at LSA Law Firm. He specializes in criminal law and human rights.', 'He speaks Armenian, Russian, English, and French.']) },
    },
    {
      slug: 'edgar-ayvazyan', imageUrl: '/images/team/team1.jpg', licenseNumber: '№ 4567', order: 3,
      ru: { name: 'Эдгар Айвазян', position: 'Партнер, Адвокат', bio: JSON.stringify(['Эдгар Айвазян является партнером и адвокатом в юридической фирме «LSA». Он специализируется в области налогового и финансового права.', 'Владеет армянским, русским и английским языками.']) },
      en: { name: 'Edgar Ayvazyan', position: 'Partner, Lawyer', bio: JSON.stringify(['Edgar Ayvazyan is a partner and lawyer at LSA Law Firm. He specializes in tax and financial law.', 'He speaks Armenian, Russian, and English.']) },
    },
    {
      slug: 'arsen-sardaryan', imageUrl: '/images/team/team2.jpg', licenseNumber: '№ 5678', order: 4,
      ru: { name: 'Арсен Сардарян', position: 'Управляющий партнер', bio: JSON.stringify(['Арсен Сардарян является управляющим партнером юридической фирмы «LSA». Он отвечает за стратегическое развитие компании и управление ключевыми проектами.', 'Владеет армянским, русским и английским языками.']) },
      en: { name: 'Arsen Sardaryan', position: 'Managing Partner', bio: JSON.stringify(['Arsen Sardaryan is the managing partner of LSA Law Firm. He is responsible for the strategic development of the company.', 'He speaks Armenian, Russian, and English.']) },
    },
    {
      slug: 'susanna-pambukchyan', imageUrl: '/images/team/team3.jpg', licenseNumber: '№ 6789', order: 5,
      ru: { name: 'Сусанна Памбукчян', position: 'Главный бухгалтер', bio: JSON.stringify(['Сусанна Памбукчян является главным бухгалтером юридической фирмы «LSA». Она отвечает за финансовый учет и отчетность компании.', 'Владеет армянским, русским и английским языками.']) },
      en: { name: 'Susanna Pambukchyan', position: 'Chief Accountant', bio: JSON.stringify(['Susanna Pambukchyan is the chief accountant of LSA Law Firm. She is responsible for financial accounting and reporting.', 'She speaks Armenian, Russian, and English.']) },
    },
  ];
  ...
  // Site Settings
  const settingsList = [
    { key: 'site_name', value: 'LSA Law Firm', ru: 'LSA Юридическая фирма', en: 'LSA Law Firm' },
    ...
    { key: 'copyright', value: '© 2024 LSA Law Firm. Все права защищены.', ru: '© 2024 LSA Law Firm. Все права защищены.', en: '© 2024 LSA Law Firm. All rights reserved.' },
    { key: 'working_hours', value: 'Пн-Пт: 09:00–18:00', ru: 'Пн-Пт: 09:00–18:00', en: 'Mon-Fri: 09:00–18:00' },
    { key: 'footer_description', value: 'Адвокатская контора «LSA» уже более 10 лет оказывает высококачественные юридические и бухгалтерские услуги в городе Ереван.', ru: 'Адвокатская контора «LSA» уже более 10 лет оказывает высококачественные юридические и бухгалтерские услуги в городе Ереван.', en: 'LSA Law Firm has been providing high-quality legal and accounting services in Yerevan for over 10 years.' },
