...
export default function EditContactPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <SessionProvider>
      <AdminLayout title="Редактировать контакт">
          ...
          <div className="admin-card">
            ...
            <div className="admin-grid admin-grid-2">
              ...
              <div className="admin-form-group">
                ...
                <input type="text" value={icon} onChange={(e) => setIcon(e.target.value)} className="admin-form-input" />
              </div>
            </div>
            <div className="admin-form-group">
              <label className="admin-form-label">Значение</label>
              <input type="text" value={value} onChange={(e) => setValue(e.target.value)} className="admin-form-input" required />
            </div>
            <div className="admin-form-group">
              <label className="admin-form-label">Ссылка (URL)</label>
              <input type="text" value={link} onChange={(e) => setLink(e.target.value)} className="admin-form-input" />
            </div>
            <div className="admin-grid admin-grid-2">
              <div className="admin-form-group">
