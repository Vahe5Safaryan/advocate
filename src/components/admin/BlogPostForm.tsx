  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="admin-card">
        ...
        <div className="admin-form-group">
          ...
          <input
            ...
            className="admin-form-input"
            placeholder="Изменения в налоговом законодательстве"
            required
          />
        </div>
        ...
        <div className="admin-form-group">
          ...
          <input
            ...
            className="admin-form-input"
            placeholder="Например: О чём эта статья"
          />
        </div>
        ...
        <div className="admin-form-group">
          ...
          <textarea
            ...
            placeholder="Вступительный параграф статьи..."
            rows={4}
          />
        </div>

        <div className="admin-form-group">
          <label className="admin-form-label">Секции статьи</label>
      ...
      <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
        <button type="button" onClick={() => router.push('/admin/blog')} className="admin-btn admin-btn-secondary">
          Отмена
        </button>
